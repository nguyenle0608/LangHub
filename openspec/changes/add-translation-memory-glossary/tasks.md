...
- [x] 1.5 Deploy migration 017, regenerate `src/types/database.ts`, inspect representative query plans, and verify the remote migration state
...
- [x] 2.4 Add unit tests for whitespace/case normalization, exact/fuzzy ordering, Unicode/short strings, literal metacharacters, whole-word matching, and missing-term warnings
...
- [x] 4.5 Add component tests for focus behavior, request cancellation/cache, explicit apply, no auto-save, failure fallback, and glossary warnings
...
- [x] 6.4 Run live exact, fuzzy, short-source, new-approval capture, suggestion acceptance, glossary CRUD/QA, and two-organization isolation smoke tests
