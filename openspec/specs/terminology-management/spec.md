# terminology-management Specification

## Purpose

Define requirements for organization glossaries: managing terms, surfacing them to translators, and keeping them tenant isolated.
