...
Defines user authentication behavior for LangHub, including email/password sign-in, Google OAuth, session establishment, callback handling, and safe auth redirects.
