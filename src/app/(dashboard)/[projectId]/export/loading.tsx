export default function ExportLoading() {
  return (
    <div className="h-screen bg-zinc-950">
      ...
      <div className="fixed inset-y-0 right-0 w-full sm:w-[420px] bg-zinc-900 border-l border-zinc-800 flex flex-col shadow-2xl">
        {/* Sheet header */}
        <div className="flex items-center justify-between px-5 py-4 border-b border-zinc-800">
          <div className="space-y-1.5">
            <div className="w-28 h-5 bg-zinc-800 rounded animate-pulse" />
            <div className="w-44 h-3.5 bg-zinc-800/60 rounded animate-pulse" />
          </div>
          ...
          <div className="space-y-2">
            {[1, 2, 3].map((i) => (
              <div key={i} className="flex items-center gap-3 py-2">
                ...
                <div className="w-6 h-6 bg-zinc-800/60 rounded-sm animate-pulse" />
                <div className="w-28 h-4 bg-zinc-800/60 rounded animate-pulse" />
              </div>
            ))}
          </div>
        </div>
