    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="mb-6 space-y-2">
          ...
          <div className="w-56 h-4 bg-zinc-800/60 rounded animate-pulse" />
        </div>
          ...
          {[1, 2, 3].map((i) => (
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                {i === 1 && <div className="w-14 h-5 bg-zinc-800 rounded-full animate-pulse" />}
                <div className="flex-1" />
                <div className="w-20 h-7 bg-zinc-800 rounded animate-pulse" />
                <div className="w-20 h-7 bg-zinc-800 rounded animate-pulse" />
              </div>
              <div className="flex gap-6 mt-2">
                <div className="w-20 h-3.5 bg-zinc-800/60 rounded animate-pulse" />
                <div className="w-20 h-3.5 bg-zinc-800/60 rounded animate-pulse" />
